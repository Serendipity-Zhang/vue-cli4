        ...
        <p>gh</p>
                   ...
                   <div class="city-contaion-con">
                            <ul>
                                ...
                                <li v-for="(city,i) in rightCitys" :key="i" >
                                    <i class="iconfont icon-left icon-cha icon-close-city"></i>
                                 {{city.name}}
                                </li>
...
export default {
  ...
  methods: {
    AddCity(data){
      console.log(data);
     // data.cityFlag = true
     for(var i = 0;i<rightCitys.length;i++){
       if (data.id == rightrightCitysCitys[i].id) return;
     }
