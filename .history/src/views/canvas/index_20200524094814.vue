...
<script>
  ...
  export default {
    ...
    draw(ctx){
        this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);//清除画布内容
        ...
        this.ctx.drawImage(this.img,this.arr[0].x,this.arr[0].y,30,30);
        //行驶的轨迹
        this.ctx.strokeStyle='green';
        this.ctx.lineTo(this.arr[0].x,this.arr[0].y);  //画点
